...
To find the equation of a tangent to a circle, or the tangent to any form of curve, required are a \textcolor{MidnightBlue}{\textbf{point}} which lies on the tangent, and its \textcolor{MidnightBlue}{\textbf{gradient}}. For tangents to circles, a geometric approach can be used:
...
\begin{center}
    \begin{tikzpicture}[scale=0.8]
        ...
        \node[above,text width=9cm] at (13,2) {The radius and tangent are perpendicular:};
        \node[below,MidnightBlue] at (13,2) {$m_{\text{radius}}\times m_{\text{tangent}}=-1$};
        \node[below, text width=9cm] at (13,1) {
...
\begin{align*}
    &g=-2\hspace{0.5cm}f=3\hspace{0.5cm}c=3&&\\[0.5em]
    \text{Centre}&=(2,-3)&&\color{MidnightBlue}\longleftarrow \text{Find the centre of the circle}\\[0.5em]
    m_{\text{radius}}&=\frac{-3-(-2)}{2-5}=\frac{-1}{-3}=\frac{1}{3}&&\color{MidnightBlue}\longleftarrow \text{Find the gradient of the radius}\\[0.5em]
