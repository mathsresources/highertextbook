...
Equating the coefficients of \(\underline{\sin{x}\degree}\) and \(\doubleunderline{\cos{x}\degree}\) gives a pair of simultaneous equations in \(k\) and \(a\):
...
Dividing \(k\sin{a}\degree\) by \(k\cos{a}\degree\) allows \(a\degree\) to be calculated. Since the positive \(\sin{a}\degree\) means \(a\degree\) must lie in either the 1st quadrant (A) or the 2nd quadrant (S), and the positive \(\cos{a}\degree\) means \(a\degree\) must lie in the 1st quadrant (A) of the 4th quadrant (C), \(a\degree\) must lie in the 1st quadrant (A).
...
\begin{align*}
    \frac{k\sin{a}\degree}{k\cos{a}\degree}&=\frac{3}{4}\\
    \color{DarkOrchid}\tan{a}\degree&\color{DarkOrchid}=\frac{3}{4}\\
...
\subsection*{Exercise 15.6}\label{exercise-15.6-1}
\addcontentsline{toc}{subsection}{Exercise 15.6}
