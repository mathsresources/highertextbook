...
\section{\texorpdfstring{The Wave Function using the Form \(k\cos{(x-a)}\)}{The Wave Function using the Form k\textbackslash cos\{(x-a)\}}}\label{the-wave-function-using-the-form-kcosx-a}
...
\section{The Wave Function using Other Forms}\label{the-wave-function-using-other-forms}
...
\section*{Multiple Angles and the Wave Function}\label{multiple-angles-and-the-wave-function}
\addcontentsline{toc}{section}{Multiple Angles and the Wave Function}

\newpage

\section*{Chapter 14 Review Exercise}\label{chapter-14-review-exercise}
\addcontentsline{toc}{section}{Chapter 14 Review Exercise}
