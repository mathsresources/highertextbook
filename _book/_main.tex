...
\begin{multicols}{5}
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (0,2) {\textcolor{green!60!black!80!}{\textit{Degree 0}}};
            \node at (0,1.5) {e.g. $7$};
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (0,2) {\textcolor{green!60!black!80!}{\textit{Degree 1}}};
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (0,2) {\textcolor{green!60!black!80!}{\textit{Degree 2}}};
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (0,2) {\textcolor{green!60!black!80!}{\textit{Degree 3}}};
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node at (0,2) {\textcolor{green!60!black!80!}{\textit{Degree 4}}};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node at (-0.75,1.2) {$3$};
        \node at (0.75,-0.4) {$2$};
        \draw[stealth-,green!60!black!80!] (6.5,1.2) -- (7.5,1.2) node[right] {\text{Coefficients of }$2x^3-7x^2+4x+1$};
        \draw[stealth-,green!60!black!80!] (-0.9,0.9) -- (-1.5,0) node[below] {$x=3$};
        \draw[-stealth,green!60!black!80!] (0.75,0.8) -- (0.75,0.2);
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        \draw[white] (-2,1.6) -- (14,1.6);
        \draw[green!10,fill=green!10] (1.9,-0.7) rectangle (2.6,1.5);
        \draw (0,1.6) -- (0,0) -- (6,0);
        \draw (4.5,0) -- (4.5,-0.8) -- (6,-0.8);
        \node at (0.75,1.2) {$2$};
        \node at (2.25,1.2) {$-7$};
        ...
        \node at (2.25,-0.4) {$-1$};
        \node[right,green!60!black!80!] at (7.5,1.2) {\textit{Multiply diagonally by 3}};
        \node[right,green!60!black!80!] at (7.5,0.4) {\textit{Add columns}};
        \draw[green!60!black!80!] (-0.75,1.2) circle (0.3cm);
        \draw[-stealth,green!60!black!80!] (1.1,-0.2) -- (1.7,0.2);
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        \draw[white] (-2,1.6) -- (14,1.6);
        \draw[green!10,fill=green!10] (4.5,-0.8) rectangle (6,0);
        \draw (0,1.6) -- (0,0) -- (6,0);
        \draw (4.5,0) -- (4.5,-0.8) -- (6,-0.8);
        \node at (0.75,1.2) {$2$};
        \node at (2.25,1.2) {$-7$};
        ...
        \node at (5.25,0.4) {$3$};
        \node at (5.25,-0.4) {$4$};
        \draw[stealth-,green!60!black!80!] (6.5,-0.4) -- (7.5,-0.4) node[right] {$\therefore f(3)=4$};
    \end{tikzpicture}
\end{center}

\begin{tcolorbox}[title=Example 10.1.1,colback=green!1, colframe=green!60!black!80!]
...
\begin{tcolorbox}[title=Example 10.2.1,colback=green!1, colframe=green!60!black!80!]
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node at (5.25,0.4) {$2$};
        \node at (5.25,-0.4) {$7$};
        \node[right,green!60!black!80!] at (6.5,-0.4) {$\longleftarrow$ \textit{Remainder}};
        \node[left,green!60!black!80!] at (-2.5,1.2) {$(x-1)$};
        \node[left,green!60!black!80!] at (-2.5,0.4) {$\rightarrow f(1)$};
    \end{tikzpicture}
\end{center}
...
\begin{tcolorbox}[title=Example 10.2.2,colback=green!1, colframe=green!60!black!80!]
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node at (5.25,-0.4) {$-1$};
        \node[right,green!60!black!80!] at (6.5,-0.4) {$\longleftarrow$ \textit{Remainder}};
        \node[left,green!60!black!80!] at (-0.5,-0.4) {\textit{Quotient}$\longrightarrow$};
    \end{tikzpicture}
\end{center}
...
\begin{align*}
    f(x)=&\text{ }(\textit{cubic})\\
    \qquad \qquad \qquad \qquad =&\text{ }(\textit{linear})(\textit{quadratic})&&\textcolor{green!60!black!80!}{\longleftarrow\textit{ Using synthetic division}}\\
    =&\text{ }(\textit{linear})(\textit{linear})(\textit{linear})
\end{align*}

\vspace{-0.3cm}

\begin{tcolorbox}[title=Example 10.3.1,colback=green!1, colframe=green!60!black!80!]
...
\end{center}
\centering
Remainder$=0\therefore (x+4)$ is a factor. \textcolor{green!60!black!80!}{$\longleftarrow$ \textit{``Show that..''}}
...
\begin{tcolorbox}[title=Example 10.3.2,colback=green!1, colframe=green!60!black!80!]
...
\end{center}
\centering
\textcolor{green!60!black!80!}{\textit{``Show that }$(x-2)$\textit{ is a factor...'' }$\longrightarrow$} Remainder$=0\therefore (x-2)$ is a factor.
...
\begin{tcolorbox}[title=Example 10.3.3,colback=green!1, colframe=green!60!black!80!]

Factorise $x^3-x^2-17x=15$.

\tcblower

\textcolor{green!60!black!80!}{\textit{Consider }$\pm1,\pm3\pm5\pm15$}\\[-0.5em]
...
\begin{align*}
    ...
    =&\text{ }(\textit{linear})(\textit{cubic})&&\textcolor{green!60!black!80!}{\longleftarrow\textit{ Using synthetic division}}\\
    \qquad \qquad \qquad =&\text{ }(\textit{linear})(\textit{linear})(\textit{quadratic})&&\textcolor{green!60!black!80!}{\longleftarrow\textit{ Using synthetic division}}\\
    =&\text{ }(\textit{linear})(\textit{linear})(\textit{linear})(\textit{linear})
\end{align*}

\vspace{-0.1cm}

\begin{tcolorbox}[title=Example 10.3.4,colback=green!1, colframe=green!60!black!80!]
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node at (5.25,0.4) {$\phantom{-}6$};
        \node at (5.25,-0.4) {$\phantom{-}0$};
        \node[left] at (-1.5,0) {\textcolor{green!60!black!80!}{\textit{Try factors of 6}}};
        \draw[green!60!black!80!,-stealth] (-1.5,0.3) -- (-0.9,0.9);
    \end{tikzpicture}
\end{center}
...
\begin{tcolorbox}[title=Example 10.4.1,colback=green!1, colframe=green!60!black!80!]
...
\begin{center}
    \begin{tikzpicture}
        ...
        \fill[green!10] (5.5,-0.8) rectangle (7.5,0);
        ...
        \node[right] at (7.7,-0.4) {\textcolor{green!60!black!80!}{$\longleftarrow$\textit{ Remainder}}};
    \end{tikzpicture}
\end{center}
\centering
...
\begin{tcolorbox}[title=Example 10.4.2,colback=green!1, colframe=green!60!black!80!]
...
\vspace{-0.3cm}
\flushleft
\textcolor{green!60!black!80!}{\textit{Solve simultaneously:}}
\vspace{-0.8cm}
\begin{center}
    \begin{tikzpicture}
        ...
        \begin{minipage}{4cm}
            \centering
            \textcolor{green!60!black!80!}{\textit{Sub }$a=-7$:}
            \vspace{-0.3cm}
            \begin{align*}
                a+b&=-3\\[0.2em]
                (-7)+b&=-3\\[0.2em]
        ...
        \draw[green!60!black!80!] (-3,-2) -- (0,-2) node[right] {\scriptsize{$(-)$}};
        \draw [decoration={brace,amplitude=0.5em},decorate,thick,green!60!black!80!]
(-4.5,-0.8) -- (-4.5,-1.8);
        \node[green!60!black!80!] at (-4.2,-1.8) {\scriptsize{$\times 2$}};
    \end{tikzpicture}
\end{center}
\end{tcolorbox}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[green!60!black!80!] at (0,-1) {Root when $x=a$};
        \node[green!60!black!80!] at (0,-1.8) {Factor of $(x-a)$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[fill] (0,0) circle (0.05) node[below] {$a$};
        \node[green!60!black!80!] at (0,-1) {Repeated root when $x=a$};
        \node[green!60!black!80!] at (0,-1.8) {Factor of $(x-a)^n$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[green!60!black!80!,stealth-] (-2.5,-0.5) -- (-3.5,-1.5) node[below left] {\textcolor{green!60!black!80!}{\textit{Repeated root}}};
    \end{tikzpicture}
\end{center}
...
\begin{align*}
    y&=k(x-1)(x-3)(x+2)^2&&\\
    6&=k(0-1)(0-3)(0+2)^2&&\textcolor{green!60!black!80!}{\textit{Substitute in }(0,6)}\\
    6&=k(-1)(-3)(2)^2&&\\
    6&=12k&&\\
    \frac{6}{12}&=k\\
    \frac{1}{2}&=k\\
    y&=\frac{1}{2}(x-1)(x-3)(x+2)^2&&\textcolor{green!60!black!80!}{\textit{State equation}}
\end{align*}
...
\begin{tcolorbox}[title=Example 12.1.1,colback=red!1!blue!1!, colframe=DarkOrchid]
...
\begin{align*}
   \sin{105\degree}=\;&\sin{(60\degree+45\degree)}&&\color{Fuchsia}\longleftarrow \text{Relate to known exact values}\\[0.5em]
    =\;&\sin{60\degree}\cos{45\degree}+\cos{60\degree}\sin{45\degree}&&\color{Fuchsia}\longleftarrow \text{Expand using formula}\\[0.5em]
    =\;&\frac{\sqrt{3}}{2}\times\frac{1}{\sqrt{2}}+\frac{1}{2}\times\frac{1}{\sqrt{2}}&&\color{Fuchsia}\longleftarrow \text{Substitute exact values}\\[0.5em]
    =\;&\frac{\sqrt{3}}{2\sqrt{2}}+\frac{1}{2\sqrt{2}}&&\\[0.5em]
    =\;&\frac{\sqrt{3}+1}{2\sqrt{2}}&&\color{Fuchsia}\longleftarrow \text{Simplify}
\end{align*}

\end{tcolorbox}

\begin{tcolorbox}[title=Example 12.1.2,colback=red!1!blue!1!, colframe=DarkOrchid]
...
\begin{align*}
    \sin{40\degree}\cos{10}-\cos{40\degree}\sin{10\degree}=\;&\sin{(40\degree-10\degree)}&&\color{Fuchsia}\longleftarrow \text{Recognise expanded form of }\sin{(A-B)}\\[0.5em]
    =\;&\sin{30\degree}&&\\[0.5em]
    =\;&\frac{1}{2}&&\color{Fuchsia}\longleftarrow \text{State exact value}
\end{align*}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[left] at (2.7,1.8) {\color{Fuchsia}By Pythagoras: $\sqrt{5^2+3^2}=$\color{black}$\sqrt{34}$};
        \node at (10,1.5) {
        \begin{minipage}{5cm}
            \begin{align*}
...
\begin{tcolorbox}[title=Example 12.2.1,colback=red!1!blue!1!, colframe=DarkOrchid]
...
\begin{align*}
    \text{Opposite side for }p&=2&&\color{Fuchsia}\longleftarrow \text{By Pythagoras: }\sqrt{\sqrt{20}^2-4^2}=\sqrt{20-16}=\sqrt{4}=2\\[0.5em]
    \text{Hypotenuse for }q&=\sqrt{40}&&\color{Fuchsia}\longleftarrow \text{By Pythagoras: }\sqrt{6^2+2^2}=\sqrt{36+4}=\sqrt{40}\\[0.5em]
\end{align*}

\centering
\textcolor{Fuchsia}{Once all side length have been calculated, values of $\sin{p},\cos{p},\sin{q},\cos{q}$ can be obtained.}

\begin{align*}
    \sin{(p+q)}&=\sin{p}\cos{q}+\cos{p}\sin{q}&&\color{Fuchsia}\longleftarrow \text{Expand addition formula}\\[0.5em]
    &=\frac{2}{\sqrt{20}}\times\frac{6}{\sqrt{40}}+\frac{4}{\sqrt{20}}\times\frac{2}{\sqrt{40}}&&\color{Fuchsia}\longleftarrow \text{Substitute using SOHCAHTOA}\\[0.5em]
    &=\frac{12}{\sqrt{800}}+\frac{8}{\sqrt{800}}&&\\[0.5em]
    &=\frac{20}{20\sqrt{2}}&&\\[0.5em]
    &=\frac{1}{\sqrt{2}}&&\color{Fuchsia}\longleftarrow \text{Simplify (and rationalise if required)}\\[0.5em]
\end{align*}
...
\begin{align*}
    \sin{2x}&\color{Fuchsia}=\sin{(x+x)}&\cos{2x}&\color{Fuchsia}=\cos{(x+x)}\\
    &\color{Fuchsia}=\sin{x}\cos{x}+\cos{x}\sin{x}&&\color{Fuchsia}=\cos{x}\cos{x}-\sin{x}\sin{x}\\
...
\begin{tcolorbox}[title=Example 12.3.1,colback=red!1!blue!1!, colframe=DarkOrchid]
...
\begin{tcolorbox}[title=Example 12.3.2,colback=red!1!blue!1!, colframe=DarkOrchid]
...
\section{Log Equations and Extraneous Solutions}\label{log-equations-and-extraneous-solutions}
