...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \begin{tikzpicture}[scale=0.6]
            \draw[-stealth] (-0.5,0) -- (8,0) node[below] {$x$};
            \draw[-stealth] (0,-2.2) -- (0,2) node[left] {$y$};
            \draw[smooth,thick,domain=0.1:8,xscale=0.8] plot (\x,{(ln(\x))/(ln(5))});
        ...
        \item $y=\log_{5}x$\\
            ...
            \draw[-stealth] (-0.5,0) -- (8,0) node[below] {$x$};
            \draw[-stealth] (0,-2.2) -- (0,2) node[left] {$y$};
            \draw[smooth,thick,domain=0.22:3,xscale=2] plot (\x,{(ln(\x))/(ln(2))});
        ...
        \item $y=\log_{5}x$\\
            ...
            \draw[-stealth] (-0.5,0) -- (8,0) node[below] {$x$};
            \draw[-stealth] (0,-2.2) -- (0,2) node[left] {$y$};
            \draw[smooth,thick,domain=0.1:15,xscale=0.5] plot (\x,{(ln(\x))/(ln(9))});
