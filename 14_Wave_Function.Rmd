...
\begin{align*}
    ...
    &&&\color{DarkOrchid}\longleftarrow \text{Negative }\sin{a}\text{: T,C, positive }\cos{a}\text{: A,C}\\[2em]
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $\sin{x}+\cos{x}$
            \item $\sqrt{3}\cos{x}-\sqrt{3}\sin{x}$
            \item $2\sqrt{3}\sin{x}-6\cos{x}$
        \end{multicols}
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $3\cos{\left(x-\frac{\pi}{6}\right)}$
            \item $5\sin{\left(x+\frac{\pi}{3}\right)}+2$
            \item $-12\sin{\left(x+\frac{\pi}{4}\right)}$
        \end{multicols}
    \end{enumerate}
    \item
    \begin{enumerate}
...
\begin{tcolorbox}[title=Example 14.4.1,colback=blue!1!red!1!, colframe=DarkOrchid]
...
\begin{align*}
    ...
    &&&\color{DarkOrchid}\longleftarrow \text{Positive }\sin\text{: quadrants A and S}\\[2.5em]
    x-21.8\degree&=48.0\degree,180\degree-48.0\degree&&\color{DarkOrchid}\longleftarrow \text{Ticked quadrants}\\[0.5em]
    x-21.8\degree&=48.0\degree,132.0\degree&&\\[0.5em]
    x\degree&=69.8\degree,153.8\degree&&\color{DarkOrchid}\longleftarrow \text{Add }21.8\degree\text{ to both sides}\\[0.5em]
\end{align*}
...
## Multiple Angles and the Wave Function {-}
