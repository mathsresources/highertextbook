...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \item $-3\sin{x}\degree-\sqrt{3}\cos{x}\degree$
        \end{multicols}
    \end{enumerate}
\end{enumerate}
...
\begin{tcolorbox}[title=Example 14.5.1,colback=blue!1!red!1!, colframe=DarkOrchid]
...
\begin{align*}
    ...
    5\cos{2t}\degree-3\sin{2t}\degree&=\sqrt{34}\sin{(x+59.0)}\degree&&\color{DarkOrchid}\longleftarrow \text{State solution}
\end{align*}
