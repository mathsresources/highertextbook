...
<!--chapter:end:01_Straight_Line.Rmd-->
...
<!--chapter:end:02_Recurrence_Relations.Rmd-->
...
<!--chapter:end:03_Differentiation_I.Rmd-->
...
<!--chapter:end:04_Quadratic_Theory.Rmd-->
...
<!--chapter:end:05_Sets_and_Functions.Rmd-->
...
<!--chapter:end:06_Trigonometry.Rmd-->
...
<!--chapter:end:07_Graph_Transformations.Rmd-->
...
<!--chapter:end:09_Differentiation_II.Rmd-->
...
<!--chapter:end:10_Polynomials.Rmd-->
...
\begin{center}
    \begin{tikzpicture}
        \draw[very thick,RoyalBlue,-stealth] (120:6) arc (120:60:6);
        \draw[very thick,RoyalBlue,-stealth] (120:6) arc (120:60:6);
    \end{tikzpicture}
\end{center}
...
\begin{itemize}
    ...
    \item[\textcolor{RoyalBlue}{\textbullet}] 11.1 Indefinite Integrals
    \item[\textcolor{RoyalBlue}{\textbullet}] 11.2 Differential Equations
    \item[\textcolor{RoyalBlue}{\textbullet}] 11.3 Definite Integrals
    \item[\textcolor{RoyalBlue}{\textbullet}] 11.4 The Area Under a Curve
    \item[\textcolor{RoyalBlue}{\textbullet}] 11.5 The Area Between Two Curves
\end{itemize}
...
\begin{tcolorbox}[title=Example 11.1.1,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    ...
    =\;&\frac{6x^3}{3}+\frac{8x^2}{2}+C&&\color{RoyalBlue}\longleftarrow \text{Constant of integration}\\[0.5em]
    =\;&2x^3+4x^2+C&&\color{RoyalBlue}\longleftarrow \text{Simplify}
\end{align*}
...
\begin{tcolorbox}[title=Example 11.1.2,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    ...
    =\;&\int \left(4x^{\frac{1}{2}}-3x^{-2}\right)\,dx&&\color{RoyalBlue}\longleftarrow \text{Preparing to integrate}\\[0.5em]
    =\;&\frac{4x^{\frac{3}{2}}}{\frac{3}{2}}-\frac{3x^{-1}}{-1}+C&&\color{RoyalBlue}\longleftarrow \text{Integrate: }\frac{1}{2}+1=\frac{1}{2}+\frac{2}{2}=\frac{3}{2}\\[0.5em]
    =\;&\frac{8}{3}x^{\frac{3}{2}}+3x^{-1}+C&&\color{RoyalBlue}\longleftarrow \text{Simplify: }4\div\frac{3}{2}=\frac{4}{1}\times\frac{2}{3}=\frac{8}{3}
\end{align*}
...
\begin{tcolorbox}[title=Example 11.1.3,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    ...
    =\;&\int \left(2x^2-5x-3\right)\,dx&&\color{RoyalBlue}\longleftarrow \text{Preparing to integrate}\\[0.5em]
    =\;&\frac{2x^3}{3}-\frac{5x^2}{2}-3x+C&&\color{RoyalBlue}\longleftarrow \text{Integral of }-3\text{ is }-3x
\end{align*}
...
\begin{tcolorbox}[title=Example 11.1.4,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{tcolorbox}[title=Example 11.3.1,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    ...
    =\;&\left[\frac{3x^3}{3}+\frac{6x^2}{2}-2x\right]_1^2&&\color{RoyalBlue}\longleftarrow \text{Integrate}\\[0.5em]
    =\;&\left[x^3+3x^2-2x\right]_1^2&&\color{RoyalBlue}\longleftarrow \text{Simplify}\\[0.5em]
    =\;&\left((2)^3+3(2)^2-2(2)\right)-\left((1)^3+5(1)^2-2(1)\right)&&\color{RoyalBlue}\longleftarrow \text{Substitute}\\[0.5em]
    =\;&16-4\\[0.5em]
    =\;&12&&\color{RoyalBlue}\longleftarrow \text{Evaluate}
\end{align*}
...
\begin{tcolorbox}[title=Example 11.4.1,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    &\displaystyle{\int_{-1}^2 \left(5+2x-x^2\right)}\,dx&&\color{RoyalBlue}\longleftarrow \text{Area}\\[0.5em]
    =\;&\left[5x+x^2-\frac{x^3}{3}\right]_{-1}^2&&\color{RoyalBlue}\longleftarrow \text{Integrate}\\[0.5em]
    =\;&\left(5(2)+(2)^2-\frac{(2)^3}{3}\right)-\left(5(-1)+(-1)^2-\frac{(-1)^3}{3}\right)&&\color{RoyalBlue}\longleftarrow \text{Substitute}\\[0.5em]
    =\;&\frac{34}{3}-\left(-\frac{11}{3}\right)&&\color{RoyalBlue}\longleftarrow \text{Evaluate}\\[0.5em]
    =\;&15\text{ square units}
\end{align*}
...
\begin{tcolorbox}[title=Example 11.4.2,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\end{center}
    ...
    \begin{tikzpicture}
        \fill[blue!20,domain=1:3,smooth] (3,0) -- (1,0) -- (1,1) -- (3,1.6) -- cycle;
        \fill[pattern color = RoyalBlue,pattern=north west lines,domain=1:3,smooth] (3,0) -- (1,0) -- (1,1) -- (3,1.6) -- cycle;
...
\begin{tcolorbox}[title=Example 11.5.1,colback=RoyalBlue!2, colframe=RoyalBlue]
...
\begin{align*}
    &\displaystyle{\int_{-1}^4 \left(4-x^2-(-3x)\right)}\,dx&&\color{RoyalBlue}\longleftarrow \text{Upper}-\text{Lower}\\[0.5em]
    &\displaystyle{\int_{-1}^4 \left(4-x^2+3x\right)}\,dx&&\color{RoyalBlue}\longleftarrow \text{Simplify}\\[0.5em]
    =\;&\left[4x-\frac{x^3}{3}+\frac{3x^2}{2}\right]_{-1}^4&&\color{RoyalBlue}\longleftarrow \text{Integrate}\\[0.5em]
    =\;&\left(4(4)-\frac{(4)^3}{3}+\frac{3(4)^2}{2}\right)-\left(4(-1)-\frac{(-1)^3}{3}+\frac{3(-1)^2}{2}\right)&&\color{RoyalBlue}\longleftarrow \text{Substitute}\\[0.5em]
    =\;&\frac{56}{3}-\left(-\frac{13}{6}\right)&&\color{RoyalBlue}\longleftarrow \text{Evaluate}\\[0.5em]
...
<!--chapter:end:11_Integration.Rmd-->
...
<!--chapter:end:12_Addition_Formulae.Rmd-->
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $8\sin{x}\degree-6\cos{x}\degree$
            \item $\cos{x}\degree-3\sin{x}\degree$
            \item $-2\sin{x}\degree-\cos{x}\degree$
        \end{multicols}
    \end{enumerate}
...
\begin{align*}
    ...
    k\sin{(x+a)}&\color{DarkOrchid}=k\sin{x}\cos{a}+k\cos{x}\sin{a}\\
    k\sin{(x-a)}&\color{DarkOrchid}=k\sin{x}\cos{a}-k\cos{x}\sin{a}
\end{align*}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $y=7\cos{(x-35)}\degree$
            \item $y=3\sin{(x-23)}\degree$
            \item $y=\sqrt{5}\cos{(x+41)}\degree$
        \end{multicols}
    \end{enumerate}
...
\begin{enumerate}
    ...
    \item 
    \begin{enumerate}
        \item Express $\sqrt{3}\sin{x}\degree+\cos{x}\degree$ in the form $k\cos{(x-a)}\degree$ where $k>0$ and $0<a<360$. 
    ...
    \item 
    \begin{enumerate}
        \item Express $3\cos{x}+2\sin{x}$ in the form $k\sin{(x+a)}$ where $k>0$ and $0<a<2\pi$. \faCalculator
        \item Hence solve the equation $2+6\cos{x}+4\sin{x}=5$ where $0<x<2\pi$. \faCalculator
    \end{enumerate}
\end{enumerate}
...
## [Wave Function Review Exercise](#ex14Ra) {-}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Express $y=3\cos{x}\degree-5\sin{x}\degree$ in the form $k\cos{(x+a)}\degree$ where $k>0$ and $0<a<360$.
        \item Hence determine the coordinates of P and Q.\\[0.5em]
    \end{enumerate}
    \item 
    \begin{enumerate}
        \item Express $2\sin{x}\degree-4\cos{x}\degree$ in the form $k\sin{(x-a)}\degree$ where $k>0$ and $0<x<360$. \faCalculator
        \item Hence state:
        \begin{enumerate}
            \item The maximum value of $2\sin{x}\degree-4\cos{x}\degree$.
            \item The value of $x$ for which it occurs, where $0<x<360$.\\[0.5em]
        \end{enumerate}
    \end{enumerate}
    \item 
    \begin{enumerate}
        \item Express $\cos{x}+\sqrt{3}\sin{x}$ in the form $k\cos{(x-a)}$ where $k>0$ and $0<a<2\pi$.
        \item Hence sketch the graph of $y=2\cos{x}+2\sqrt{3}\sin{x}$ for $0<x<2\pi$.\\[0.5em]
    \end{enumerate}
    \item 
    \begin{enumerate}
        \item Express $6\cos{t}\degree-3\sin{t}\degree$ in the form $k\cos{(t+a)\degree}$ where $k>0$ and $0<a<360$. \faCalculator
        \item Hence solve $2\cos{t}\degree-\sin{t}\degree+2=1$ where $0<t<360$. \faCalculator\\[0.5em]
    \end{enumerate}
    \item 
    \begin{enumerate}
        \item Express $\sin{2x}\degree-\cos{2x}\degree$ in the form $k\sin{(2x-a)}$ where $k>0$ and $0<a<360$.
...
<!--chapter:end:14_Wave_Function.Rmd-->
...
One advantage of defining this function is the ability to calculate the value at times other than after a whole number of years. For example, the value after \textcolor{PineGreen}{three and a half years} can be calculated as:
...
\vspace{-0.5cm}
This describes \textcolor{PineGreen}{\textbf{exponential growth}}.
...
\vspace{-0.5cm}
This describes \textcolor{PineGreen}{\textbf{exponential decay}}.
...
\begin{align*}
    ...
    f(x)&> 1&&\color{PineGreen}\longleftarrow\text{State range}
\end{align*}
...
\begin{enumerate}
    ...
    \vspace{-0.2cm}
        \begin{multicols}{2}
            ...
            \draw[smooth,thick,domain=-3:1.32] plot (\x,{3^(\x)-1});
            \draw[fill] (0,0) circle (0.07);
            \draw[fill] (1.262,3) circle (0.07) node[right] {$(1,3)$};
            \node[above left] {\scriptsize{O}};
            \draw[dashed,thin] (-4,-1) -- (2.5,-1) node[right] {$y=-1$};
            \draw[fill,PineGreen] (0.631,1) circle (0.07) node[right] {$\left(\frac{1}{2},k\right)$};
            \end{tikzpicture}
            \item[(b)] $y=a^x$\\
            \begin{tikzpicture}[scale=0.8]
            \draw[-stealth] (-4,0) -- (4,0) node[below] {$x$};
            ...
            \draw[fill] (0,2) circle (0.07) node[above left] {$4$};
            \draw[fill] (1,2.5) circle (0.07) node[below right] {$(1,5)$};
    ...
    \begin{enumerate}
        ...
        \begin{multicols}{4}
            ...
            \item $y=\left(\frac{1}{2}\right)^x-1$
            \item $y=\left(\frac{1}{2}\right)^{x-2}$
            \item $y=\left(\frac{1}{2}\right)^{1-x}$
        \end{multicols}
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    \item State the value of each of the following logarithms:
    \begin{enumerate}
        \begin{multicols}{5}
            \item $\log_6{36}$
            \item $\log_5{125}$
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{multicols}{3}
            ...
            \item $\log_5{\frac{1}{4}}+2\log_{5}{10}$
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \item $\frac{1}{2}\log_{6}{9}+\log_{6}{5}$
            \item $2\log_{2}{9}-3\log_2{3}$
        \end{multicols}
    \end{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \item $\log_{a}{12}-\frac{1}{3}\log_{a}{8}$
            \item $\log_{a}{120}-\log_a{4}+\log_a{\frac{1}{15}}$
        \end{multicols}
    \end{enumerate}
\end{enumerate}
...
\begin{align*}
\log_3{x}-\log_3{2}&=2\color{PineGreen}\log_3{3} &&\color{PineGreen}\longleftarrow\text{Multiply the 2 by}\log_33\\[0.5em]
...
\begin{enumerate}
    ...
    \begin{enumerate} 
        ...
        \end{multicols}
        \begin{multicols}{2}    
            \item $\log_{6}{5}+\log_{6}{(x-1)}=\log_{6}{30}$
...
Knowledge of the graph of $y=\log_a{x}$ may be combined with an understanding of graph transformations.
...
Given $37=21e^{-0.48k}$, find the value of $k$ to three significant figures. \faCalculator
...
#### [Exercise 15.7](#ex157a) {-}

\vspace{-0.5cm}

\begin{enumerate}
    \item For each, find the value of $k$ to three significant figures: \faCalculator
    \vspace{-0.2cm}
    \begin{enumerate}
        \begin{multicols}{4}
            \item $0.7=e^{k}$
...
The behaviour of many things in the real-world can be appropriately modelled using \textcolor{PineGreen}{\textbf{exponential growth}} or \textcolor{PineGreen}{\textbf{exponential decay}} functions.

Time, $t$, is a common variable for such a function in place of $x$. Such functions are often named suitably to match the variable they describe (rather than using $y$ or $f(x)$), such as $V$ for *"value"*, $P$ for *"population size"* or $M$ for *"mass"*. Where $\color{PineGreen}k>0$:
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Find, to the nearest hundred, the number of bacteria after 45 minutes.
    ...
    \begin{enumerate}
        ...
        \end{multicols}
    \end{enumerate}
    \item The temperature $T$ (in $\degree\text{C}$) of a substance $t$ minutes after a chemical reaction can be modelled by the equation $T=T_0e^{-kt}$. After 7 minutes, the substance has cooled from $140\degree\text{C}$ to $55\degree\text{C}$.
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Find the time taken for the concentration to reduce by half.
...
## [Logs and Exponentials Review Exercise](#ex15Ra) {-}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $\log_{8}{6}+\log_{8}{12}-\log_{8}{9}$
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            \item $\ln{x}-\ln{5}=\ln{2}$
            \item $\log_{6}{x}+\log_{6}{4}=2$
            \item $\log_2{x}+\log_2{(x+7)}=3$
        \end{multicols}
    \end{enumerate}
    \item Given that $\log_{p}{4}+3=\log_p{32}$, find the value of $p$.
    \item A population of mice is discovered living in some woodland. The number of mice can be modelled by:
    \[M=80e^{kt}\]
    ...
    \end{enumerate}
    \item Variables $x$ and $y$ are linked by the equations given below. Find the values of $a$ and $b$ for each:
    \begin{multicols}{2}
        \begin{center}
            \begin{tikzpicture}[scale=0.8]
                \draw[white] (-3,-1) rectangle (6,4);
                \node[below right] at (-3,4) {(a)};
                \node[below left] at (6,4) {$y=ax^b$};
                \draw[-stealth] (-2,0) -- (5,0) node[below] {$\log_3{x}$};
                \draw[-stealth] (0,-1) -- (0,3.5) node[left] {$\log_3{y}$};
                \draw[thick] (0,1) circle (0.05) node[left] {$(0,2)$} -- (2,2) circle (0.05) node[right] {$(4,4)$};
                \node[below left] {\scriptsize{O}};
            \end{tikzpicture}
        \end{center}
        \begin{center}
            \begin{tikzpicture}[scale=0.8]
                \draw[white] (-3,-1) rectangle (6,4);
                \node[below right] at (-3,4) {(b)};
                \node[below left] at (6,4) {$y=ab^x$};
                \draw[-stealth] (-2,0) -- (5,0) node[below] {$x$};
                \node[above left] {\scriptsize{O}};
                \draw[-stealth] (0,-1) -- (0,3.5) node[left] {$\log_9{y}$};
                \draw[thick] (0,-0.5) circle (0.05) node[left] {$(0,-1)$} -- (2.5,2.5) circle (0.05) node[right] {$(3,5)$};
            \end{tikzpicture}
        \end{center}
        \end{multicols}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.8]
                    ...
                    \draw[fill] (3,1) circle (0.05) node[below right] {$(3,1)$};
                    \draw[fill] (5,2) circle (0.05) node[above] {$(5,2)$};
                    \draw[dashed] (2,-1) -- (2,2) node[above] {$x=2$};
                \end{tikzpicture}
                \end{center}
                \columnbreak
                \begin{center}
                \begin{enumerate}
                    \item State the domain of $f(x)$.\\[2em]
                    \item Find the values of $a$ and $b$.\\[2em]
                    \item Sketch the graph of $y=f^{-1}(x)$.
                \end{enumerate}
                \end{center}
                \end{multicols}
\end{enumerate}
...
<!--chapter:end:15_Logs_and_Exponentials.Rmd-->
...
<!--chapter:end:16_Further_Calculus.Rmd-->
...
<!--chapter:end:17_Challenge_Problems.Rmd-->
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \draw[black,fill] (0.8,0) circle (0.08) node[below right] {$1$};
            \draw[black,fill] (0.8*5,1) circle (0.08) node[above] {$(5,1)$};
            \end{tikzpicture}
        \end{center}
        \item $y=\log_{2}x$\\
            \begin{center}
            ...
            \draw[black,fill] (2,0) circle (0.08) node[below right] {$1$};
            \draw[black,fill] (2*2,1) circle (0.08) node[above] {$(2,1)$};
            \end{tikzpicture}
        \end{center}
        \item $y=\log_{9}x$\\
            \begin{center}
            ...
            \draw[black,fill] (0.5,0) circle (0.08) node[below right] {$1$};
            \draw[black,fill] (0.5*9,1) circle (0.08) node[above] {$(9,1)$};
            \end{tikzpicture}
        \end{center}
        \end{multicols}
    \end{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \draw[black,fill] (0.8,0.49) circle (0.08) node[above] {$(1,1)$};
            \draw[black,fill] (0.8*4,1.19) circle (0.08) node[above] {$(4,2)$};
            \end{tikzpicture}
        \end{center}
        \item $y=\log_{7}x-1$\\
            \begin{center}
            ...
            \draw[black,fill] (0.6,-0.5) circle (0.08) node[below right] {$(1,-1)$};
            \draw[black,fill] (4.2,0) circle (0.08) node[above] {$(7,0)$};
            \end{tikzpicture}
        \end{center}
        \item $y=\log_{5}x+2$\\
            \begin{center}
            ...
            \draw[black,fill] (1,0.75) circle (0.08) node[above] {$(1,2)$};
            \draw[black,fill] (5,1.25) circle (0.08) node[above] {$(5,3)$};
            \end{tikzpicture}
        \end{center}
        \end{multicols}
    \end{enumerate}
    \begin{enumerate}[resume]
        \begin{multicols}{3}
            ...
            \draw[black,fill] (3,0) circle (0.08) node[below right] {$5$};
            \draw[black,fill] (6.5,1) circle (0.08) node[above] {$(8,6)$};
        ...
        \item $y=\log_{2}(x+3)$\\
            ...
            \draw[black,fill] (-2,0) circle (0.08) node[below right] {$-2$};
            \draw[black,fill] (-1,1) circle (0.08) node[above left,xshift=0.2cm,yshift=-0.1cm] {$(-1,1)$};
        ...
        \item $y=\log_{3}(x-2)$\\
            ...
            \draw[black,fill] (1.5,0) circle (0.08) node[below right] {$3$};
            \draw[black,fill] (2.5,1) circle (0.08) node[below right,yshift=0.2cm,xshift=-0.1cm] {$(5,1)$};
    ...
    \begin{enumerate}[resume]
        \begin{multicols}{3}
            ...
            \draw[black,fill] (-1,2) circle (0.08) node[above left] {$(-2,2)$};
            \draw[black,fill] (2,3) circle (0.08) node[below] {$(4,3)$};
        ...
        \item $y=\log_{5}(x-3)+1$\\
            ...
            \draw[black,fill] (2,1) circle (0.08) node[below right] {$(4,1)$};
            \draw[black,fill] (4,2) circle (0.08) node[above] {$(8,2)$};
        ...
        \item $y=\log_{6}(x+2)-1$\\
            ...
            \draw[black,fill] (-0.5,-1) circle (0.08) node[right,xshift=0.2cm] {$(-1,-1)$};
            \draw[black,fill] (2,0) circle (0.08) node[above] {$(4,0)$};
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \begin{multicols}{3}
            ...
            \vspace{-0.5cm}
            \begin{tikzpicture}[scale=0.6]
            \draw[-stealth] (-2,0) -- (5.5,0) node[below] {$x$};
            \draw[-stealth] (0,-0.4) -- (0,3.6) node[left] {$y$};
            \draw[smooth,samples=100,thick,domain=-1:2.5,xscale=1.5,yscale=0.1] plot (\x,{4^(\x)+2});
            \draw[black,fill] (0,0.3) circle (0.08) node[above left] {$3$};
            \draw[black,fill] (1.5,0.6) circle (0.08) node[right,yshift=-0.1cm,xshift=0.05cm] {$(1,6)$};
            \end{tikzpicture}
        \end{center}
        \item $y=5^{x+2}$\\
            \begin{center}
            \vspace{-0.5cm}
            \begin{tikzpicture}[scale=0.6]
            \draw[-stealth] (-2.5,-0.1) -- (5,-0.1) node[below] {$x$};
            \draw[-stealth] (-0.1,-0.4) -- (-0.1,3.6) node[left] {$y$};
            \draw[smooth,samples=100,thick,domain=-1.2:1.9,xscale=2,yscale=0.005] plot (\x,{5^(\x+2)});
            \draw[black,fill] (-0.1,25*0.005) circle (0.08) node[above left] {$25$};
            \draw[black,fill] (2,125*0.005) circle (0.08) node[right,yshift=-0.1cm,xshift=0.1cm] {$(1,125)$};
            \draw[fill] (-2,5*0.005) circle (0.08);
            \draw[stealth-] (-2,0.2) -- (-1.5,2) node[above] {$(-1,5)$};
            \end{tikzpicture}
        \end{center}
        \item $y=\log_3{(x-2)}+4$\\
            \begin{center}
            \vspace{-0.5cm}
            \begin{tikzpicture}[scale=0.6]
            \draw[-stealth] (-0.5,0) -- (7,0) node[below] {$x$};
            \draw[-stealth] (0,-0.4) -- (0,3.6) node[left] {$y$};
            \draw[smooth,samples=100,thick,domain=2.005:13,xscale=0.5,yscale=0.5] plot (\x,{(ln(\x-2))/(ln(3))+4});
            \draw[black,fill] (1.5,2) circle (0.08) node[below right,xshift=-0.1cm,yshift=0.1cm] {$(3,4)$};
            \draw[black,fill] (2.5,2.5) circle (0.08) node[above] {$(5,5)$};
            \draw[dashed] (0.9,0) -- (0.9,2.5) node[above] {\scriptsize{$x=2$}};
            \end{tikzpicture}
        \end{center}
        \end{multicols}
    \end{enumerate}
    ...
    \begin{enumerate}
            ...
            \draw[-stealth] (-2,0) -- (5.5,0) node[below] {$x$};
            \draw[-stealth] (0,-0.4) -- (0,3.6) node[left] {$y$};
            \draw[smooth,samples=100,thick,domain=-1.5:3.4,xscale=1,yscale=0.2] plot (\x,{3^(\x-1)+2});
            \draw[black,fill] (1,0.6) circle (0.08) node[above] {$(1,3)$};
            \draw[black,fill] (2,1) circle (0.08) node[right,xshift=0.05cm] {$(2,5)$};
            \draw[dashed] (-1.5,0.3) -- (3.5,0.3) node[right] {\scriptsize{$y=2$}};
            \end{tikzpicture}
            \end{center}
    \end{enumerate}
    \end{multicols}
