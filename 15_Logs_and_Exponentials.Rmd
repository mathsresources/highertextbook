...
$\color{PineGreen}y=k\color{PineGreen}x^{\color{PineGreen}n}$, taking any $\log_a$ of both sides will reveal a \textcolor{PineGreen}{linear relationship} will exist between $\color{PineGreen}\log_ax$ and $\color{PineGreen}\log_ay$.
...
\begin{align*}
    \color{PineGreen}y&=k\color{PineGreen}x^{\color{black}n}\\[0.5em]
    log_a{y}&=log_a{\left(kx^n\right)}\\[0.5em]
    log_a{y}&=log_a{x^n}+log_a{k}\\[0.5em]
    \color{PineGreen}log_a{y}&=n\color{PineGreen}log_a{x}\color{black}+log_a{k}\\
    &\hspace{1cm} \downarrow\\
    \color{PineGreen}log_a{y}&=m\color{PineGreen}log_a{x}\color{black}+c
\end{align*}
...
\begin{center}
    \begin{tikzpicture}
          \draw[-stealth] (-0.2,0) -- (4,0) node[below] {$\color{PineGreen}\log_a{x}$};
          \draw[-stealth] (0,-0.2) -- (0,4) node[left] {$\color{PineGreen}\log_a{y}$};
          \node[below left] {\scriptsize{O}};
    \end{tikzpicture}
\end{center}
...
or an \textcolor{PineGreen}{exponential} function such as $y=ab^{\color{PineGreen}x}$, takin
