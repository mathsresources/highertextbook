    ...
    \begin{multicols}{2}
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[thick] (0,0.5) node[left] {$(0,2)$} -- (3,3) node[below right] {$(2,12)$} -- (3.3,3.25);
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[thick] (0,0.8) node[left] {$(0,4)$} -- (4,2.4) node[below right] {$(16,12)$} -- (4.2,2.48);
    ...
    \begin{multicols}{2}
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[thick] (0,3) node[below left] {$(0,3)$} -- (3,1) node[above right] {$(3,1)$} -- (3.75,0.5);
    ...
    \begin{multicols}{2}
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[-stealth] (0,-2.5) -- (0,2) node[left] {$\log_a{y}$};
                \node[below left] {\scriptsize{O}};
            \end{tikzpicture}
        \end{center}
    \end{multicols}
