...
\begin{tcolorbox}[title=Example,colback=PineGreen!2!, colframe=PineGreen,width=8.5cm,height=2.9cm]
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{multicols}
    \end{enumerate}
    \item By considering negative and fractional indices as well as integers, evaluate each:
    \begin{enumerate}
        \begin{multicols}{5}
            \item $\log_2{32}$
            \item $\log_{4}{4}$
...
\begin{tcolorbox}[title=Example,colback=PineGreen!2!, colframe=PineGreen,height=5.6cm]
...
\begin{tcolorbox}[title=Example,colback=PineGreen!2!, colframe=PineGreen,height=7cm]

Solve the equation $\log_2{40}-\log_2{x}=3$.
...
\begin{align*}
\log_2{40}-\log_2{x}&=3\color{PineGreen}\log_2{2} &&\color{PineGreen}\longleftarrow\text{Multiply the constant by}\log_22\\[0.5em]
\log_2{\left(\frac{40}{x}\right)}&=\log_2{2^3} && \color{PineGreen}\longleftarrow\text{Apply quotient and power laws}\\[0.5em]
\frac{40}{x}&=8 && \color{PineGreen}\longleftarrow\text{"Cancel" }\log_2\text{ from both sides}\\[0.5em]
40&=8x && \color{PineGreen}\longleftarrow\text{Multiply both sides by }x\\[0.5em]
5&=x && \color{PineGreen}\longleftarrow\text{Solve}
\end{align*}
